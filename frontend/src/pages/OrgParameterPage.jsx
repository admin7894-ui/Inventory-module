...
import {
  ...
  departmentsApi, rolesApi, designationApi, workdayCalendarApi,
} from '../services/api'
...
export default function OrgParameterPage() {
  ...
  const dropdowns = {
    ...
    workdayCalendar: workdayCalendars,
  }
      ...
      <FormPage title={view === 'view' ? `View Org Parameter` : view === 'edit' ? `Edit Org Parameter` : `New Org Parameter`}
        ...
        <div className="card p-6 mb-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Field label="Workday Calendar Id"><Select value={formData.workday_calendar_id} onChange={v => setField('workday_calendar_id', v)} options={dropdowns.workdayCalendar?.map(r => { return { value: r.workday_calendar_id, label: r.calendar_name || r.workday_calendar_id } })} /></Field>
            ...
            <Field label="Lot Control Enabled"><Toggle value={formData.lot_control_enabled} onChange={v => setField('lot_control_enabled', v)} /></Field>
            <Field label="Serial Control Enabled"><Toggle value={formData.serial_control_enabled} onChange={v => setField('serial_control_enabled', v)} /></Field>
