...
const COLUMNS = [
  ...
  { key: 'txn_reason', label: 'Txn Reason' },
  { key: 'module_id', label: 'Module Id' }
]

export default function TransactionReasonPage() {
  const navigate = useNavigate()
  const table = useTableData(transactionReasonApi, 'transaction_reason')
  ...
  const handleDelete = async () => {
    await table.remove(confirmDelete['txn_reason_id'])
  ...
  return (
    <>
      <DataTable
        ...
        subtitle="Manage Transaction Reason records"
        columns={COLUMNS}
        data={table.rows}
        total={table.total}
        page={table.page}
