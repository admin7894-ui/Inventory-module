...
export default function ItemCategoryPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (view === 'edit') {
        await table.update(selected['category_id'], formData)
      } else {
  ...
  if (view !== 'list') {
    return (
      ...
      <Field label="Category Set"><Select value={formData.category_set_id} onChange={v => setField('category_set_id',v)} options={dropdowns.categorySet?.map(r=>{return{value:r.category_set_id,label:r.category_set_name||r.category_set_id}})} /></Field>
      <Field label="Category Code"><Input value={formData.category_code} onChange={e => setField('category_code',e.target.value)} /></Field>
      <Field label="Category Name"><Input value={formData.category_name} onChange={e => setField('category_name',e.target.value)} /></Field>
