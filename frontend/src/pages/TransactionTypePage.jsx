...
export default function TransactionTypePage() {
  ...
  if (view !== 'list') {
    return (
      ...
      <Field label="Txn Type Code"><Input value={formData.txn_type_code} onChange={e => setField('txn_type_code',e.target.value)} /></Field>
      <Field label="Txn Type Name"><Input value={formData.txn_type_name} onChange={e => setField('txn_type_name',e.target.value)} /></Field>
      ...
      <Field label="Txn Category"><Input value={formData.txn_category} onChange={e => setField('txn_category',e.target.value)} /></Field>
