...
const PATTERNS = {
  ...
  bg_id: /^BG\d{1,5}$/,
  company_id: /^C\d{1,5}$/,
  business_type_id: /^BT\d{1,5}$/,
  item_id: /^ITEM-\d{1,6}$/,
  txn_id: /^TXN\d{1,5}$/,
  stock_id: /^STK-\d{1,6}$/,
  ledger_id: /^SLG-\d{1,6}$/,
  adjustment_id: /^ADJ-\d{1,6}$/,
  tracking_id: /^TRK-\d{1,6}$/,
  opening_stock_id: /^OPS-\d{1,6}$/,
  locator_id: /^BIN-\d{1,6}$/,
  lot_id: /^LOT\d{1,5}$/,
  serial_id: /^SER\d{1,5}$/,
  uom_id: /^UOM\d{1,5}$/,
  ...
  item_code: /^[A-Z0-9_]{2,30}$/,
  calendar_code: /^[A-Z0-9_]{2,20}$/,
  active_flag: /^(Y|N)$/,
  effective_from: /^\d{4}-\d{2}-\d{2}$/,
  effective_to: /^(\d{4}-\d{2}-\d{2})?$/,
  hsn_code: /^[0-9]{4,8}$/,
  reference_no: /^[A-Z0-9_\-]{2,30}$/,
  fiscal_year: /^FY\d{4}$/,
