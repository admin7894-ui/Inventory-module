...
exports.update = (req, res) => {
  try {
    ...
    // Uniqueness check for locator_code
    if (req.body.locator_code && (db[TABLE]||[]).find(r => r.locator_code === req.body.locator_code && r[PK] !== req.params.id))
      return res.status(400).json({ success:false, message:`Locator Code "${req.body.locator_code}" already exists` });
